...
public:
    ...
    {
        PIG_Cor cor = {0,0,0,255};
        SDL_GetTextureColorMod(text,&cor.r,&cor.g,&cor.b);
        return cor;
    }
    ...
    void DesenhaSprite(double X, double Y, double Largura, double Altura, float Angulo, PIG_Cor cor)
    {
        //SDL_RenderCopyEx(renderer, text, &frame,&dest,-angulo,&pivoRelativo,flip);
