...
#define MAX_ANIMACOES           100
#define MAX_FRAMES              100
#define MAX_FRAMES_MODO         100
#define MAX_MODOS               50

#define MAX_OBJETOS             100000
#define MAX_ATRIBUTOS_OBJETO    10
...
#define ROXO            ((PIG_Cor){143,0,255,255})
...
#define QTD_CORES 11
PIG_Cor cores[QTD_CORES] = { BRANCO,    PRETO,  VERMELHO,
                             VERDE,     AZUL,   ROSA,
...
botao: indica qual dos três botões foi pressionado ou liberado
...
#define BOTAO_ESQUERDO          SDL_BUTTON_LEFT
#define BOTAO_CENTRAL           SDL_BUTTON_MIDDLE
#define BOTAO_DIREITO           SDL_BUTTON_RIGHT
