...
public:
    ...
    inline static PIG_Cor GetColoracao(int idObjeto){
        return objetos[idObjeto]->GetColoracao();
    }
    ...
    inline static void DesenhaSprite(int id_objeto, double X, double Y, double Largura, double Altura, double angulo, PIG_Cor cor){
        objetos[id_objeto]->DesenhaSprite(X,Y,Largura,Altura,angulo,cor);
    }

    inline static PIG_Cor getCorPixel(int id_objeto, int coluna, int linha)
    {
        PIG_Cor cor;
        int largura, altura;

        GetDimensoesOriginais(id_objeto, &altura, &largura);
        ...
        cor.a = CGerenciadorObjetos::objetos[id_objeto]->pixels[(altura-1)-linha][coluna].a;
        cor.r = CGerenciadorObjetos::objetos[id_objeto]->pixels[(altura-1)-linha][coluna].r;
        cor.g = CGerenciadorObjetos::objetos[id_objeto]->pixels[(altura-1)-linha][coluna].g;
        cor.b = CGerenciadorObjetos::objetos[id_objeto]->pixels[(altura-1)-linha][coluna].b;
